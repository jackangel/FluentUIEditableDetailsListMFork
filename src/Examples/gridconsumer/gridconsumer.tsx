...
const Consumer = () => {
    ...
    const [gridConfigOptions, setGridConfigOptions] =
        useState<GridConfigOptions>({
            enableCellEdit: true,
            enableRowEdit: true,
    ...
    const onTeachingBubbleNavigation = (direction: string) => {
        switch (direction) {
            case 'previous':
                ...
                setTeachingBubblePropsConfig({
                    id: currentId,
                    config: TeachingProps,
                });
                break;
            case 'next':
                var TeachingProps =
    ...
    return (
        <Fabric>
            ...
            <EditableGrid
                ...
                enableTextFieldEditMode={
                    gridConfigOptions.enableTextFieldEditMode
                }
                ...
                enableColumnFilterRules={
                    gridConfigOptions.enableColumnFilterRules
                }
            ...
            {teachingBubbleVisible && (
                <TeachingBubble
                    ...
                    primaryButtonProps={
                        teachingBubblePropsConfig?.id <
                        teachingBubbleConfig.length - 1
                            ? nextBubbleProps
                            : closeButtonProps
                    }
                    secondaryButtonProps={
                        teachingBubblePropsConfig?.id > 0
                            ? previousBubbleProps
                            : null
                    }
                    onDismiss={toggleTeachingBubbleVisible}
                    footerContent={
                        teachingBubblePropsConfig?.config.footerContent
                    }
