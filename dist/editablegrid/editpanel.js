...
var EditPanel = function EditPanel(props) {
  ...
  var onCheckboxUpdate = function onCheckboxUpdate(ev, column) {
    if (ev) SetObjValues(ev.target.id, ev.target.checked ? 1 : 0);
  };
  ...
  var createTextFields = function createTextFields() {
    ...
    props.columnConfigurationData.filter(function (x) {
      ...
      var _item$pickerOptions$p, _item$pickerOptions, _item$pickerOptions2, _item$dropdownValues;
